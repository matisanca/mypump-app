-- (Traída al repo el 19-sep-2026: vivía solo en la mini como ~/070.sql, aplicada
--  el 11-sep. El repo tenía la definición de la 025, que es justamente la que
--  causaba el bug. El "b" del nombre es porque el 070 del repo ya era el matcher.)
